...
public class CameraSource {
  ...
  private com.dcca.jane.mmy.dalin.camera.FrameProcessor frameProcessor;
  ...
  private final com.dcca.jane.mmy.dalin.camera.GraphicOverlay graphicOverlay;

  public CameraSource(com.dcca.jane.mmy.dalin.camera.GraphicOverlay graphicOverlay) {
  ...
  public void setFrameProcessor(com.dcca.jane.mmy.dalin.camera.FrameProcessor processor) {
    graphicOverlay.clear();
    synchronized (processorLock) {
      if (frameProcessor != null) {
        frameProcessor.stop();
  ...
  private void setPreviewAndPictureSize(Camera camera, Parameters parameters) throws IOException {
    ...
    com.dcca.jane.mmy.dalin.camera.CameraSizePair sizePair = PreferenceUtils.getUserSpecifiedPreviewSize(context);
    if (sizePair == null) {
   ...
   */
  private static com.dcca.jane.mmy.dalin.camera.CameraSizePair selectSizePair(Camera camera, float displayAspectRatioInLandscape) {
    List<com.dcca.jane.mmy.dalin.camera.CameraSizePair> validPreviewSizes = Utils.generateValidPreviewSizeList(camera);

    com.dcca.jane.mmy.dalin.camera.CameraSizePair selectedPair = null;
    // Picks the preview size that has closest aspect ratio to display view.
    float minAspectRatioDiff = Float.MAX_VALUE;
    for (com.dcca.jane.mmy.dalin.camera.CameraSizePair sizePair : validPreviewSizes) {
  ...
  private class FrameProcessingRunnable implements Runnable {
    ...
    public void run() {
      ...
      while (true) {
        ...
        try {
          synchronized (processorLock) {
            com.dcca.jane.mmy.dalin.camera.FrameMetadata frameMetadata =
                new com.dcca.jane.mmy.dalin.camera.FrameMetadata(previewSize.getWidth(), previewSize.getHeight(), rotation);
