...
import com.dcca.jane.mmy.dalin.camera.GraphicOverlay;
import com.dcca.jane.mmy.dalin.camera.WorkflowModel;
import com.dcca.jane.mmy.dalin.camera.WorkflowModel.WorkflowState;
import com.dcca.jane.mmy.dalin.objectdetection.DetectedObject;
import com.dcca.jane.mmy.dalin.objectdetection.MultiObjectProcessor;
import com.dcca.jane.mmy.dalin.objectdetection.ProminentObjectProcessor;
import com.dcca.jane.mmy.dalin.productsearch.BottomSheetScrimView;
import com.dcca.jane.mmy.dalin.productsearch.Product;
import com.dcca.jane.mmy.dalin.productsearch.ProductAdapter;
import com.dcca.jane.mmy.dalin.productsearch.SearchEngineCloud;
import com.dcca.jane.mmy.dalin.productsearch.SearchedObject;
import com.dcca.jane.mmy.dalin.settings.PreferenceUtils;
import com.dcca.jane.mmy.dalin.settings.SettingsActivity;
  ...
  private boolean checkblogpost(List<Product> pd){
    ...
    for(int i=0; i < pd.size(); i++) {
      ...
      if (pd.get(i).title.contains("Metal") || pd.get(i).title.contains("Can") )  {
        ...
        view.setData(Uri.parse("http:///www.dalin.website/kaen/"));
        startActivity(view);
        flag = 1;
        break;
      }
        ...
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/jongipaegryu/"));
        startActivity(view);
        flag = 1;
        break;
      }  // water bottle
        ...
        view.setData(Uri.parse("http://www.dalin.website/peteubyeong/"));
        flag = 1;
        startActivity(view);
        break;
      }  // Fruit
        ...
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/gwailryu/"));
        startActivity(view);
        flag = 1;
        break;
      }
      //box
        ...
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/bagseu/"));
        startActivity(view);
        flag = 1;
        break;
      }  // plastic
        ...
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/plastic/"));
        flag = 1;
        startActivity(view);
      }  // glass
        ...
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/yuribyeong/"));
        startActivity(view);
        flag = 1;
        break;
      }
        ...
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/jongi/"));
        startActivity(view);
        flag = 1;
        break;
      }
        ...
        //Toast.makeText(getApplicationContext(), "Paper", Toast.LENGTH_LONG).show();
        Intent view = new Intent(Intent.ACTION_VIEW);
        view.setData(Uri.parse("http://www.dalin.website/mouse/"));
        startActivity(view);
        flag = 1;
        break;
      }  // fruit
