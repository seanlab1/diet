...
package com.dcca.jane.mmy.dalin.settings;
...
import com.dcca.jane.mmy.activities.Utils;
import com.dcca.jane.mmy.dalin.camera.CameraSizePair;
    ...
    try {
      ...
      previewSizePreference.setOnPreferenceChangeListener(
          (preference, newValue) -> {
            ...
            com.dcca.jane.mmy.dalin.settings.PreferenceUtils.saveStringPreference(
                getActivity(),
